...
class WhmcsConfig
{
    ...
    const DISK_BILLING_DESC = 'Billing ID of the Hard Disks. Multiple can be separated by commas (without spaces). Setting this will override user-selected disk options.';
    const ADDON_BILLING_DESC = 'Billing ID of the Addons. Multiple can be separated by commas (without spaces). Setting this will override user-selected addon options.';
